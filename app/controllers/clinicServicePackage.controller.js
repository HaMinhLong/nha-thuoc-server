  ...
  ClinicServicePackage.findOne({
    ...
    .catch((err) => {
      res.status(200).json({
        success: true,
        error: err.message,
        message: "Xảy ra lỗi khi lấy thông tin nhóm dịch vụ!",
      });
    });
};
...
const create = async (req, res) => {
  ...
  if (clinicServicePackage) {
    res.status(200).json({
      success: false,
      error: "Nhóm dịch vụ đã tồn tại!",
      message: "Nhóm dịch vụ đã tồn tại!",
    });
  } else {
    ClinicServicePackage.create({
      ...
      .catch((err) => {
        res.status(200).json({
          success: false,
          error: err.message,
          message: "Xảy ra lỗi khi tạo mới nhóm dịch vụ!",
        });
      });
  }
};
    ...
    ClinicServicePackage.update(
      ...
      .catch((err) => {
        res.status(200).json({
          success: false,
          error: err.message,
          message: "Xảy ra lỗi khi cập nhật nhóm dịch vụ!",
        });
      });
  }
};
  ...
  ClinicServicePackage.destroy({
    ...
    .catch((err) => {
      res.status(200).json({
        success: false,
        message: err.message,
        message: "Xảy ra lôi khi xóa nhóm dịch vụ!",
      });
    });
};
module.exports = {
